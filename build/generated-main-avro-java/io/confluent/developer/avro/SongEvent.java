...
public class SongEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9157922490919689319L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SongEvent\",\"namespace\":\"io.confluent.developer.avro\",\"fields\":[{\"name\":\"artist\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"title\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public SongEvent(java.lang.String artist, java.lang.String title) {
    this.artist = artist;
    this.title = title;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: artist = value$ != null ? value$.toString() : null; break;
   ...
   */
  public static io.confluent.developer.avro.SongEvent.Builder newBuilder() {
    return new io.confluent.developer.avro.SongEvent.Builder();
  }
   ...
   * @return A new SongEvent RecordBuilder
   */
  public static io.confluent.developer.avro.SongEvent.Builder newBuilder(io.confluent.developer.avro.SongEvent.Builder other) {
    if (other == null) {
      return new io.confluent.developer.avro.SongEvent.Builder();
    } else {
      return new io.confluent.developer.avro.SongEvent.Builder(other);
    }
  }
   ...
   * @return A new SongEvent RecordBuilder
   */
  public static io.confluent.developer.avro.SongEvent.Builder newBuilder(io.confluent.developer.avro.SongEvent other) {
    if (other == null) {
      return new io.confluent.developer.avro.SongEvent.Builder();
    } else {
      return new io.confluent.developer.avro.SongEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SongEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.confluent.developer.avro.SongEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.confluent.developer.avro.SongEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.artist)) {
        this.artist = data().deepCopy(fields()[0].schema(), other.artist);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.SongEvent.Builder setArtist(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.SongEvent.Builder clearArtist() {
      artist = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.SongEvent.Builder setTitle(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.confluent.developer.avro.SongEvent.Builder clearTitle() {
      title = null;
